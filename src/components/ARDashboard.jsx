...
const ARDashboard = ({ onBack }) => {
  ...
  const summaryColumns = [
    ...
    },
    {
      ...
      width: 100,
      render: (_, record) => {
        const rate = record.accountingAR > 0 
          ? Math.round((record.paid / record.accountingAR) * 100)
          : 0
        return (
  ...
  return (
    ...
    <div className="ar-dashboard-container">
      <Card>
          ...
          <Row align="middle" justify="space-between">
            <Col>
              <Space>
                ...
                <h2 style={{ margin: 0 }}>
                  <LineChartOutlined /> AR Dashboard - Công nợ Khách hàng
                </h2>
              </Space>
            </Col>
            <Col>
        ...
        {/* Drawer chi tiết */}
        <Drawer
          title={`Chi tiết đơn hàng - ${selectedCustomerDetail?.customerName}`}
          placement="right"
